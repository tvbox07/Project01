...
# # 한글 엑셀 불러올경우 pip install xlrd 실행해야함.
...
# 딕셔너리 저장
# 엑셀 읽기
a1 = pd.read_excel('D:\Coding\PythonWorkspace02\webscrapping\stock_scrapping\stock_list01.xls', header=0)
...
f = open("./stock_list01.csv", "w", encoding="utf-8-sig", newline="") #한글이 깨지지 않게 저장하기 utf-8-sig
writer = csv.writer(f)
...
# csv 파일열어 데이터 불러오기
g = open("./stock_list01.csv", "r", encoding="utf-8-sig")
reader = csv.reader(g)
# print(reader)
data = list(reader)
# print(data[0][0])
